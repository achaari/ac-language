...
AC_EXTERN int __ac_init_proc(p_accmpl_ cmplhndp, const char *procname);
...
#define __ac_exec_step(stat, ...)  if(! __ac_proc_step(TRUE, stat, __VA_ARGS__)) { return(__ac_stop_proc(cmplhndp)); }
